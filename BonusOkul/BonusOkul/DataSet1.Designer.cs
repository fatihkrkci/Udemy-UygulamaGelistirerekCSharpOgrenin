...
FROM     Tbl_Ogrenciler INNER JOIN
            ...
            this._commandCollection[1] = new global::System.Data.SqlClient.SqlCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = @"SELECT Tbl_Ogrenciler.OgrenciID, Tbl_Ogrenciler.OgrenciAd, Tbl_Ogrenciler.OgrenciSoyad, Tbl_Kulupler.KulupAd, Tbl_Ogrenciler.OgrenciCinsiyet
FROM     Tbl_Ogrenciler INNER JOIN
                  Tbl_Kulupler ON Tbl_Ogrenciler.OgrenciKulup = Tbl_Kulupler.KulupID
...
SELECT NotID, DersID, OgrenciID, Sinav1, Sinav2, Sinav3, Proje, Ortalama, Durum FROM Tbl_Notlar WHERE (NotID = @NotID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT NotID, DersID, OgrenciID, Sinav1, Sinav2, Sinav3, Proje, Ortalama, Durum F" +
                "ROM Tbl_Notlar WHERE (OgrenciID = @OgrenciID)";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
